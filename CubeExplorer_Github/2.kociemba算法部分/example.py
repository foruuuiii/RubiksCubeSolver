...
cubestring = 'RDFRUUUUBDLLURRRLDFFRFFRDBUBUFLDDLDRUFLDLLUBLDRBBBBFFB'  # cube definition string of cube we want to solve
# See module enums.py for the format of the cube definition string
# UFDRUBDLR DUFLRFDFF BDFDFUFDB UFRBDUUBU BULLLRBRR LRRLBBLDL
...
print(a)
a = sv.solve(cubestring, 10, 5)  # solve with a maximum of 18 moves and a timeout of 5 seconds for example
print(a)
quit()
