...
canvas.pack()
carGif=PhotoImage(file="gxu.png")
gxu= Label(text='',height=190,width=180,image=carGif)
gxu_window =canvas.create_window( 6+ 0 * width, 11 + 6* width, anchor=NW, window=gxu)
